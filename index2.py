...
# loginReqDts = {"username": "1436089483@qq.com","page_session_id": "0181A946-984D-9819-D238-2D1AF5854F64" }
# loginHeaders = {
...
# }
# commonCookie = {} # 公共cookie

# res =  requests.post(loginUrl, data=loginReqDts,headers=loginHeaders, cookies=commonCookie)

# # 新增的cookie
# commonCookie.update(requests.utils.dict_from_cookiejar(res.cookies))
ctx = execjs.compile(open('./create_page_session_id.js','r',encoding='utf-8').read())
ctx2 = execjs.compile(open('./pp_index3.js','r',encoding='utf-8').read())
sign = ctx.eval("le()")
