...
> 注意：不同的api接口，用来拼接的成encParams的a.data是不一样的。

- 像`https://dl.reg.163.com/dl/zj/mail/gt`他们的`a.data是`
```js
	{
		channel: 0,
		pd:"cbg",
...
- 但是`https://dl.reg.163.com/dl/zj/mail/l`的就要多得多
```js
	{
		channel: 0,
		d: 10,
		...
		pd: "cbg",
		pkid: "aqpOBwV",
		pw: "eSDTaVpA5RGRWf/Vv2gAnQfufkxmZzgwFj7UUlRzUfrJ4KWbae576tfQjRFUoS/KHM/qxV4h3nrBtDBN/vwqTVliV3TWBaaKXlJJhk3ekWFcLjzxgOWEtAxMzBQTJCJsVfwg8GJX1vKMPuyzjux8Afebcqqm0geyj8OwMS01eQE=",
		pwdKeyUp: 1,
		rtid: "hmApBQFUb9EKTU4BiCbUP9UbQANtterf",
		t: 1666947239135,
		tk: "8defc13218289268d31f086d71e56961",
		topURL: "https://xyq-m.cbg.163.com/cgi/mweb/show_login?back_url=%2Fcgi%2Fmweb%2Flogin%2Frecent-role%3Fback_url%3Dhttps%253A%252F%252Fxyq-m.cbg.163.com%252Fcgi%252Fmweb%252Flogin%252Frole%252F35%252F416%253Fbac",
		un: "123123@163.com",
	}
```
注意，这个有个tk字段，是从`https://dl.reg.163.com/dl/zj/mail/gt`的返回结果拿到的
## 网易的流程
